...
public class Madlib
{
    public static void main(String[] args)
    {
        ...
        System.out.println("Henry Baldwin \nWilliam Barney \nZoe Leclair \nSanthosh Ramanathan \nKirubashinilakshana Senthilnathan \nReed Stringham");
        System.out.println("If you would like to support us, please donate to Bitybooce on Roblox Pls Donate.");
        System.out.println("------------------------------------------------------------------------------------------");
        ...
        while(loop) {
            ...
            if(story == 1) {
                ...
                System.out.println("Her cape whipped in the wind as she traced the " + exThing.get(0) + " in her hand, knowing that stealing it was the worst decision she'd ever made. She turned and headed to the hidden " + strt.get(0) + " to make the final transfer, where she would finally have all she needed to leave her dark past behind.");
                ...
                System.out.println("As she crashed it into the " + lrgTh.get(0) + ", and covered it with rotten "+ food.get(0) + " which so happened to be his favourite food she felt so "+ emo.get(0) +", she could only imagine her father's reaction when he discovered what she had done. Her father came by " + time.get(0) +" later and was very " + emo.get(1) + "." );
                ...
                System.out.println("Confused by the situation and having no big leads, she called in a friend named " + name.get(2) + " who was " + verb.get(0) + ". She then heard...");
